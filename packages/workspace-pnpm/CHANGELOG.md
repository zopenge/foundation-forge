...
- 616de22: 新增可复用 workspace 检查框架、pnpm CLI 组装与包循环门禁；pnpm workspace 清单缺少 packages 时按空工作区处理。
...
- Updated dependencies [90357aa]
  - @openge/forge-workspace-graph@0.1.0
...
- Add an explicit pnpm workspace discovery provider for workspace graphs.
